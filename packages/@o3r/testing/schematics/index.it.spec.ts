...
describe('new otter application with testing', () => {
  ...
  test('should add testing to existing application', () => {
    execSync(`${packageManagerCmd.add} @o3r/testing@${o3rVersion}`, execAppOptions);
    execSync(`${packageManagerCmd.exec} ng add @o3r/testing@${o3rVersion} --skip-confirmation --defaults=true --force --verbose`, execAppOptions);

    execSync(`${packageManagerCmd.exec} ng g @o3r/core:component --defaults=true test-component`, execAppOptions);
    execSync(`${packageManagerCmd.exec} ng g @o3r/testing:add-fixture --defaults=true --path="src/components/test-component/container/test-component-cont.component.ts"`, execAppOptions);
