...
describe('new otter application with extractors', () => {
  ...
  test('should add extractors to existing application', () => {
    execSync(`${packageManagerCmd.add} @o3r/extractors@${o3rVersion}`, execAppOptions);
    execSync(`${packageManagerCmd.exec} ng add @o3r/extractors@${o3rVersion} --skip-confirmation --defaults=true --force --verbose`, execAppOptions);
