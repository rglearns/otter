...
Once you've generated `SDK_CONTEXT.md` files for your SDKs, you can expose them to AI assistants using the [@ama-sdk/mcp package](https://github.com/AmadeusITGroup/otter/tree/main/mcps/ama-sdk-mcp).
...
- [@ama-sdk/mcp Documentation](https://github.com/AmadeusITGroup/otter/tree/main/mcps/ama-sdk-mcp)
